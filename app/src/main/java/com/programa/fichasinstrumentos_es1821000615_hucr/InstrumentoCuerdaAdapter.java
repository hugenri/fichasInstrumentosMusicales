...
public class InstrumentoCuerdaAdapter extends RecyclerView.Adapter<InstrumentoCuerdaAdapter.InstrumentoViewHolder> {

    private List<Instrumento> instrumentos;

    public InstrumentoCuerdaAdapter(List<Instrumento> instrumentos) {
        ...
        public void bind(final Instrumento instrumento) {
            ...
            checkboxEstudiado.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((CuerdaActivity) itemView.getContext()).onCheckboxClicked(v);
                }
            });
        }
    }
