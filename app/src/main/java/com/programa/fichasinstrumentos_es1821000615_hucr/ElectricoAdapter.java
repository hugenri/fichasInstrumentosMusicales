...
public class ElectricoAdapter extends RecyclerView.Adapter<ElectricoAdapter.InstrumentoViewHolder> {

    private List<Instrumento> instrumentos;

    public ElectricoAdapter(List<Instrumento> instrumentos) {
        ...
        public void bind(final Instrumento instrumento) {
            ...
            checkboxEstudiado.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((ElectricoActivity) itemView.getContext()).onCheckboxClicked(v);
                }
            });
        }
    }
